        ...
        <div class="container">
            <div class="row clearfix">
                <div class="col-md-6 col-md-offset-6 column">
                    <div class="jumbotron">
                        <h2 style="color: #e48632">登录装修帮办会员</h2>
                        ...
                        <span class="input-group-addon" style="text-align: left">
                            <a href="${pageContext.request.contextPath}/account/weixinlogin">
                                <i class="fa fa-weixin" aria-hidden="true"
                                   style="color: #83d944;font-size: 28px"></i><span style="color: black">微信</span></a>
                        </span>
